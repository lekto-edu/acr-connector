...
| Channel | Where | Notes |
|---|---|---|
| **Container image** | `ghcr.io/lekto-edu/acrity-connector` | Public, multi-arch (`linux/amd64` + `linux/arm64`) |
| **Native binaries** | [Releases](https://github.com/lekto-edu/acr-connector/releases) | Single-file, self-contained — Linux / Windows / macOS, x64 + arm64 |
...
```bash
docker pull ghcr.io/lekto-edu/acrity-connector:latest
# or pin a version:
docker pull ghcr.io/lekto-edu/acrity-connector:0.0.1
```
...
services:
  acrity-connector:
    image: ghcr.io/lekto-edu/acrity-connector:latest
...
```yaml
image:
  repository: ghcr.io/lekto-edu/acrity-connector
  tag: latest
...
[latest release](https://github.com/lekto-edu/acr-connector/releases/latest):
...
```bash
# Linux/macOS example
curl -fsSLO https://github.com/lekto-edu/acr-connector/releases/latest/download/acrity-connector-linux-x64
curl -fsSLO https://github.com/lekto-edu/acr-connector/releases/latest/download/SHA256SUMS
...
Releases are tagged `connector-v<semver>` (e.g. `connector-v0.0.1`). The container image is
